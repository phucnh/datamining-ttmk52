...
{	
	...
	///</summary>
	public abstract partial class TeacherDetailsProviderBaseCore : EntityProviderBase<AIDT.Entities.TeacherDetails, AIDT.Entities.TeacherDetailsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIDT.Entities.TeacherDetailsKey key)
		{
		...
		public override AIDT.Entities.TeacherDetails Get(TransactionManager transactionManager, AIDT.Entities.TeacherDetailsKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public AIDT.Entities.TeacherDetails GetByTeacherId(System.Int32 _teacherId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public AIDT.Entities.TeacherDetails GetByTeacherId(System.Int32 _teacherId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public AIDT.Entities.TeacherDetails GetByTeacherId(TransactionManager transactionManager, System.Int32 _teacherId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public AIDT.Entities.TeacherDetails GetByTeacherId(TransactionManager transactionManager, System.Int32 _teacherId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public AIDT.Entities.TeacherDetails GetByTeacherId(System.Int32 _teacherId, int start, int pageLength, out int count)
		{
			return GetByTeacherId(null, _teacherId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.TeacherDetails"/> class.</returns>
		public abstract AIDT.Entities.TeacherDetails GetByTeacherId(TransactionManager transactionManager, System.Int32 _teacherId, int start, int pageLength, out int count);
		...
		public static TList<TeacherDetails> Fill(IDataReader reader, TList<TeacherDetails> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIDT.Entities.TeacherDetails c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIDT.Entities.TeacherDetails();
				}
					...
					))
				{
					...
					c.OriginalTeacherId = c.TeacherId;
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.TeacherDetails"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.TeacherDetails"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIDT.Entities.TeacherDetails entity)
		{
			if (!reader.Read()) return;
			
			entity.TeacherId = (System.Int32)reader[((int)TeacherDetailsColumn.TeacherId - 1)];
			entity.OriginalTeacherId = (System.Int32)reader["TeacherId"];
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.TeacherDetails"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.TeacherDetails"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIDT.Entities.TeacherDetails entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.TeacherId = (System.Int32)dataRow["TeacherId"];
			entity.OriginalTeacherId = (System.Int32)dataRow["TeacherId"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIDT.Entities.TeacherDetails"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIDT.Entities.TeacherDetails Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIDT.Entities.TeacherDetails entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIDT.Entities.TeacherDetails object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIDT.Entities.TeacherDetails instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIDT.Entities.TeacherDetails Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIDT.Entities.TeacherDetails entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIDT.Entities.TeacherDetails</c>
	///</summary>
