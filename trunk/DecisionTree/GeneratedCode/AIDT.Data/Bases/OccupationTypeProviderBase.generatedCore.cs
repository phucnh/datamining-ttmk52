...
{	
	...
	///</summary>
	public abstract partial class OccupationTypeProviderBaseCore : EntityProviderBase<AIDT.Entities.OccupationType, AIDT.Entities.OccupationTypeKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIDT.Entities.OccupationTypeKey key)
		{
		...
		public override AIDT.Entities.OccupationType Get(TransactionManager transactionManager, AIDT.Entities.OccupationTypeKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public AIDT.Entities.OccupationType GetByOccupationTypeId(System.Int32 _occupationTypeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public AIDT.Entities.OccupationType GetByOccupationTypeId(System.Int32 _occupationTypeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public AIDT.Entities.OccupationType GetByOccupationTypeId(TransactionManager transactionManager, System.Int32 _occupationTypeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public AIDT.Entities.OccupationType GetByOccupationTypeId(TransactionManager transactionManager, System.Int32 _occupationTypeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public AIDT.Entities.OccupationType GetByOccupationTypeId(System.Int32 _occupationTypeId, int start, int pageLength, out int count)
		{
			return GetByOccupationTypeId(null, _occupationTypeId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.OccupationType"/> class.</returns>
		public abstract AIDT.Entities.OccupationType GetByOccupationTypeId(TransactionManager transactionManager, System.Int32 _occupationTypeId, int start, int pageLength, out int count);
		...
		public static TList<OccupationType> Fill(IDataReader reader, TList<OccupationType> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIDT.Entities.OccupationType c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIDT.Entities.OccupationType();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.OccupationType"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.OccupationType"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIDT.Entities.OccupationType entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.OccupationType"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.OccupationType"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIDT.Entities.OccupationType entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIDT.Entities.OccupationType"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIDT.Entities.OccupationType Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIDT.Entities.OccupationType entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIDT.Entities.OccupationType object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIDT.Entities.OccupationType instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIDT.Entities.OccupationType Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIDT.Entities.OccupationType entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIDT.Entities.OccupationType</c>
	///</summary>
