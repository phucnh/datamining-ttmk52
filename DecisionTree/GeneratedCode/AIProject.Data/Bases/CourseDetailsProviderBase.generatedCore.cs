...
{	
	...
	///</summary>
	public abstract partial class CourseDetailsProviderBaseCore : EntityProviderBase<AIProject.Entities.CourseDetails, AIProject.Entities.CourseDetailsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIProject.Entities.CourseDetailsKey key)
		{
		...
		/// <returns>Returns a typed collection of AIProject.Entities.CourseDetails objects.</returns>
		...
		public override AIProject.Entities.CourseDetails Get(TransactionManager transactionManager, AIProject.Entities.CourseDetailsKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public AIProject.Entities.CourseDetails GetByCourseId(System.Int32 _courseId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public AIProject.Entities.CourseDetails GetByCourseId(System.Int32 _courseId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public AIProject.Entities.CourseDetails GetByCourseId(TransactionManager transactionManager, System.Int32 _courseId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public AIProject.Entities.CourseDetails GetByCourseId(TransactionManager transactionManager, System.Int32 _courseId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public AIProject.Entities.CourseDetails GetByCourseId(System.Int32 _courseId, int start, int pageLength, out int count)
		{
			return GetByCourseId(null, _courseId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.CourseDetails"/> class.</returns>
		public abstract AIProject.Entities.CourseDetails GetByCourseId(TransactionManager transactionManager, System.Int32 _courseId, int start, int pageLength, out int count);
		...
		public static TList<CourseDetails> Fill(IDataReader reader, TList<CourseDetails> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIProject.Entities.CourseDetails c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIProject.Entities.CourseDetails();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="AIProject.Entities.CourseDetails"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIProject.Entities.CourseDetails"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIProject.Entities.CourseDetails entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="AIProject.Entities.CourseDetails"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIProject.Entities.CourseDetails"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIProject.Entities.CourseDetails entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIProject.Entities.CourseDetails"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIProject.Entities.CourseDetails Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIProject.Entities.CourseDetails entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIProject.Entities.CourseDetails object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIProject.Entities.CourseDetails instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIProject.Entities.CourseDetails Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIProject.Entities.CourseDetails entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIProject.Entities.CourseDetails</c>
	///</summary>
