...
{	
	...
	///</summary>
	public abstract partial class ClassDetailsProviderBaseCore : EntityProviderBase<AIProject.Entities.ClassDetails, AIProject.Entities.ClassDetailsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIProject.Entities.ClassDetailsKey key)
		{
		...
		/// <returns>Returns a typed collection of AIProject.Entities.ClassDetails objects.</returns>
		...
		public override AIProject.Entities.ClassDetails Get(TransactionManager transactionManager, AIProject.Entities.ClassDetailsKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public AIProject.Entities.ClassDetails GetByClassId(System.Int32 _classId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public AIProject.Entities.ClassDetails GetByClassId(System.Int32 _classId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public AIProject.Entities.ClassDetails GetByClassId(TransactionManager transactionManager, System.Int32 _classId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public AIProject.Entities.ClassDetails GetByClassId(TransactionManager transactionManager, System.Int32 _classId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public AIProject.Entities.ClassDetails GetByClassId(System.Int32 _classId, int start, int pageLength, out int count)
		{
			return GetByClassId(null, _classId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="AIProject.Entities.ClassDetails"/> class.</returns>
		public abstract AIProject.Entities.ClassDetails GetByClassId(TransactionManager transactionManager, System.Int32 _classId, int start, int pageLength, out int count);
		...
		public static TList<ClassDetails> Fill(IDataReader reader, TList<ClassDetails> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIProject.Entities.ClassDetails c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIProject.Entities.ClassDetails();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="AIProject.Entities.ClassDetails"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIProject.Entities.ClassDetails"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIProject.Entities.ClassDetails entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="AIProject.Entities.ClassDetails"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIProject.Entities.ClassDetails"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIProject.Entities.ClassDetails entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIProject.Entities.ClassDetails"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIProject.Entities.ClassDetails Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIProject.Entities.ClassDetails entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIProject.Entities.ClassDetails object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIProject.Entities.ClassDetails instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIProject.Entities.ClassDetails Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIProject.Entities.ClassDetails entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIProject.Entities.ClassDetails</c>
	///</summary>
