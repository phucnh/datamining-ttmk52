...
{	
	...
	///</summary>
	public abstract partial class CourseCertificateProviderBaseCore : EntityProviderBase<AIDT.Entities.CourseCertificate, AIDT.Entities.CourseCertificateKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIDT.Entities.CourseCertificateKey key)
		{
		...
		public override AIDT.Entities.CourseCertificate Get(TransactionManager transactionManager, AIDT.Entities.CourseCertificateKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public AIDT.Entities.CourseCertificate GetByCertificateId(System.Int32 _certificateId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public AIDT.Entities.CourseCertificate GetByCertificateId(System.Int32 _certificateId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public AIDT.Entities.CourseCertificate GetByCertificateId(TransactionManager transactionManager, System.Int32 _certificateId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public AIDT.Entities.CourseCertificate GetByCertificateId(TransactionManager transactionManager, System.Int32 _certificateId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public AIDT.Entities.CourseCertificate GetByCertificateId(System.Int32 _certificateId, int start, int pageLength, out int count)
		{
			return GetByCertificateId(null, _certificateId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CourseCertificate"/> class.</returns>
		public abstract AIDT.Entities.CourseCertificate GetByCertificateId(TransactionManager transactionManager, System.Int32 _certificateId, int start, int pageLength, out int count);
		...
		public static TList<CourseCertificate> Fill(IDataReader reader, TList<CourseCertificate> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIDT.Entities.CourseCertificate c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIDT.Entities.CourseCertificate();
				}
					...
					))
				{
					...
					c.OriginalCertificateId = c.CertificateId;
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.CourseCertificate"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CourseCertificate"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIDT.Entities.CourseCertificate entity)
		{
			if (!reader.Read()) return;
			
			entity.CertificateId = (System.Int32)reader[((int)CourseCertificateColumn.CertificateId - 1)];
			entity.OriginalCertificateId = (System.Int32)reader["CertificateId"];
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.CourseCertificate"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CourseCertificate"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIDT.Entities.CourseCertificate entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.CertificateId = (System.Int32)dataRow["CertificateId"];
			entity.OriginalCertificateId = (System.Int32)dataRow["CertificateId"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CourseCertificate"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIDT.Entities.CourseCertificate Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIDT.Entities.CourseCertificate entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIDT.Entities.CourseCertificate object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIDT.Entities.CourseCertificate instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIDT.Entities.CourseCertificate Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIDT.Entities.CourseCertificate entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIDT.Entities.CourseCertificate</c>
	///</summary>
