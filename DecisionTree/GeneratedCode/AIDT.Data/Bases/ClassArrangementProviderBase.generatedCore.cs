...
{	
	...
	///</summary>
	public abstract partial class ClassArrangementProviderBaseCore : EntityProviderBase<AIDT.Entities.ClassArrangement, AIDT.Entities.ClassArrangementKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIDT.Entities.ClassArrangementKey key)
		{
		...
		/// <returns>Returns a typed collection of AIDT.Entities.ClassArrangement objects.</returns>
		...
		public override AIDT.Entities.ClassArrangement Get(TransactionManager transactionManager, AIDT.Entities.ClassArrangementKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(TransactionManager transactionManager, System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(TransactionManager transactionManager, System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate, int start, int pageLength, out int count)
		{
			return GetByCustomerIdClassIdCreateDate(null, _customerId, _classId, _createDate, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.ClassArrangement"/> class.</returns>
		public abstract AIDT.Entities.ClassArrangement GetByCustomerIdClassIdCreateDate(TransactionManager transactionManager, System.Int32 _customerId, System.Int32 _classId, System.DateTime _createDate, int start, int pageLength, out int count);
		...
		public static TList<ClassArrangement> Fill(IDataReader reader, TList<ClassArrangement> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIDT.Entities.ClassArrangement c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIDT.Entities.ClassArrangement();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.ClassArrangement"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.ClassArrangement"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIDT.Entities.ClassArrangement entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.ClassArrangement"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.ClassArrangement"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIDT.Entities.ClassArrangement entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIDT.Entities.ClassArrangement"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIDT.Entities.ClassArrangement Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIDT.Entities.ClassArrangement entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIDT.Entities.ClassArrangement object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIDT.Entities.ClassArrangement instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIDT.Entities.ClassArrangement Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIDT.Entities.ClassArrangement entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIDT.Entities.ClassArrangement</c>
	///</summary>
