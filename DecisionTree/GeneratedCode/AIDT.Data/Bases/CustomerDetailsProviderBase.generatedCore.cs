...
{	
	...
	///</summary>
	public abstract partial class CustomerDetailsProviderBaseCore : EntityProviderBase<AIDT.Entities.CustomerDetails, AIDT.Entities.CustomerDetailsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AIDT.Entities.CustomerDetailsKey key)
		{
		...
		/// <returns>Returns a typed collection of AIDT.Entities.CustomerDetails objects.</returns>
		...
		public override AIDT.Entities.CustomerDetails Get(TransactionManager transactionManager, AIDT.Entities.CustomerDetailsKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public AIDT.Entities.CustomerDetails GetByCustomerId(System.Int32 _customerId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public AIDT.Entities.CustomerDetails GetByCustomerId(System.Int32 _customerId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public AIDT.Entities.CustomerDetails GetByCustomerId(TransactionManager transactionManager, System.Int32 _customerId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public AIDT.Entities.CustomerDetails GetByCustomerId(TransactionManager transactionManager, System.Int32 _customerId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public AIDT.Entities.CustomerDetails GetByCustomerId(System.Int32 _customerId, int start, int pageLength, out int count)
		{
			return GetByCustomerId(null, _customerId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="AIDT.Entities.CustomerDetails"/> class.</returns>
		public abstract AIDT.Entities.CustomerDetails GetByCustomerId(TransactionManager transactionManager, System.Int32 _customerId, int start, int pageLength, out int count);
		...
		public static TList<CustomerDetails> Fill(IDataReader reader, TList<CustomerDetails> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AIDT.Entities.CustomerDetails c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AIDT.Entities.CustomerDetails();
				}
					...
					))
				{
					...
					c.Birthday = (reader.IsDBNull(((int)CustomerDetailsColumn.Birthday - 1)))?null:(System.String)reader[((int)CustomerDetailsColumn.Birthday - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.CustomerDetails"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CustomerDetails"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AIDT.Entities.CustomerDetails entity)
		{
			...
			entity.Birthday = (reader.IsDBNull(((int)CustomerDetailsColumn.Birthday - 1)))?null:(System.String)reader[((int)CustomerDetailsColumn.Birthday - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="AIDT.Entities.CustomerDetails"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CustomerDetails"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AIDT.Entities.CustomerDetails entity)
		{
			...
			entity.Birthday = Convert.IsDBNull(dataRow["Birthday"]) ? null : (System.String)dataRow["Birthday"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AIDT.Entities.CustomerDetails"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AIDT.Entities.CustomerDetails Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AIDT.Entities.CustomerDetails entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AIDT.Entities.CustomerDetails object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AIDT.Entities.CustomerDetails instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AIDT.Entities.CustomerDetails Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AIDT.Entities.CustomerDetails entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AIDT.Entities.CustomerDetails</c>
	///</summary>
